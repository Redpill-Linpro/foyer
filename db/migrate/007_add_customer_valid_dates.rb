...
class AddCustomerValidDates < ActiveRecord::Migration
  def self.up
    add_column :customers, :valid_from, :date
    add_column :customers, :valid_to,   :date
  end

  def self.down
    remove_column :customers, :valid_from
    remove_column :customers, :valid_to
  end
end