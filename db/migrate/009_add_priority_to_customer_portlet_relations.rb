...
class AddPriorityToCustomerPortletRelations < ActiveRecord::Migration
  def self.up
    add_column :customer_portlet_relations, :priority, :integer, :null => false, :default => 1000
  end

  def self.down
    remove_column :customer_portlet_relations, :priority
  end
end