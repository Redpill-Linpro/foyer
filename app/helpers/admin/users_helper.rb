...
module Admin::UsersHelper
  ...
  def user_customer_relations_column(record)
    # Don't use customers here, as it is all customers this user has access to.
    record.customer_relations.map {|c| c.customer.handle}.join(", ")
  end
