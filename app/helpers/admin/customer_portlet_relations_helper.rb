...
module Admin::CustomerPortletRelationsHelper
  def created_by_input(record)
    created_by(CustomerPortletRelation, record)
  end

  def updated_by_input(record)
    updated_by(CustomerPortletRelation, record)
  end
end