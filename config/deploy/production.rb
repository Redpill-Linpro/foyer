...
role :web, "web.prod.example.com"                   # Your HTTP server, Apache/etc
role :app, "app.prod.example.com"                   # This may be the same as your `Web` server
role :db,  "db.prod.example.com", :primary => true  # This is where Rails migrations will run
