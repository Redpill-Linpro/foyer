...
#config.gem 'rspec',       :version => '>= 1.3.1', :lib => false unless File.directory?(File.join(Rails.root, 'vendor/plugins/rspec'))
#config.gem 'rspec-rails', :version => '>= 1.3.1', :lib => false unless File.directory?(File.join(Rails.root, 'vendor/plugins/rspec-rails'))

#config.gem 'factory_girl', :version => '= 1.2.3', :lib => false # For some reason we need version 1.2.3 for pre-Rails 3.